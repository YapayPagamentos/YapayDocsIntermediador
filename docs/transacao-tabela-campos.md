...
| transaction[max_days_to_keep_waiting_payment] | Não | Texto/255            | Dias máximo que a transação ficará com o status Aguardando Pagamento. Se informado junto com a data de vencimento do boleto, essa data será iniciada pela data de vencimento do boleto. |
